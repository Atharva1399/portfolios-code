...
export function MorphingCardStack({
  ...
  const containerStyles = {
    ...
    grid: "grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl",
              ...
              return (
                <motion.div
                  ...
                  className={cn(
                    ...
                    layout === "stack" && "absolute w-72 h-64 md:w-80 md:h-72",
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                      <h3 className="font-semibold text-card-foreground text-lg">{card.title}</h3>
                      <p
                        className={cn(
